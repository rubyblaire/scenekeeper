...
public sealed class TaskShareService
{
        ...
        out string message)
    {
        ...
        {
            message = "No task share payload was provided.";
            return false;
        }
        ...
        {
            message = $"Could not read task share payload: {ex.Message}";
            return false;
        }
        ...
        message = $"Imported shared tasks. Added: {added}, updated: {updated}.";
        return true;
    }
